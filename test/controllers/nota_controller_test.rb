...
class NotaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notum" do
    assert_difference('Notum.count') do
      post nota_url, params: { notum: { enologo_id: @notum.enologo_id, puntaje: @notum.puntaje, vino_id: @notum.vino_id } }
    end
  ...
  test "should update notum" do
    patch notum_url(@notum), params: { notum: { enologo_id: @notum.enologo_id, puntaje: @notum.puntaje, vino_id: @notum.vino_id } }
