...
class CargosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cargo" do
    assert_difference('Cargo.count') do
      post cargos_url, params: { cargo: { enologo_id: @cargo.enologo_id, name: @cargo.name, revista_id: @cargo.revista_id } }
    end
  ...
  test "should update cargo" do
    patch cargo_url(@cargo), params: { cargo: { enologo_id: @cargo.enologo_id, name: @cargo.name, revista_id: @cargo.revista_id } }
